...
\begin{document}
	...
	\section{Background}
		...
		\subsection{Standard Genetic Programming}
			...
			Genetic operators are then applied to the chosen programmes to create a new generation. The three most common operators are:
			...
			\begin{itemize}
				...
				The selected programme is copied into the new generation without modification
				...
				A random node is selected in each of the two chosen programmes. The subtrees rooted at the selected nodes are swapped.
